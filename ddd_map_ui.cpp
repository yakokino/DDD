...
void DDDMap::setEnableScroll( bool enable_flag )
{
	camera_data.enable_scroll = enable_flag;
}

CAMERA_DATA* DDDMap::getCameraData()
{
	return &camera_data;
}
...
std::vector<WINDOW_DATA> DDDUI::window_list;		//ウィンドウリスト
AnimDraw DDDUI::ui_anim;
AnimDraw DDDUI::window_anim;
